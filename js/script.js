"use strict";
class locations {
    constructor(name, address, zip, city, img, created) {
        this.name = name;
...
class restaurant extends locations {
    constructor(name, address, zip, city, img, created, telNum, link) {
...
class events extends restaurant {
    constructor(name, address, zip, city, img, created, telNum, link, dateTime, price, currency) {
